"""create pbti_recommendation table

Revision ID: 076e0e2baf47
Revises: 21198248bda8
Create Date: 2025-11-22 14:29:17.887249
...
revision: str = '076e0e2baf47'
down_revision: Union[str, Sequence[str], None] = '21198248bda8'
...
def upgrade() -> None:
    ...
    op.add_column('pbti_question', sa.Column('axis', sa.Integer(), nullable=False))
    ...
    op.add_column('pbti_result', sa.Column('temperature_score', sa.Integer(), nullable=False))
    op.add_column('pbti_result', sa.Column('texture_score', sa.Integer(), nullable=False))
    op.add_column('pbti_result', sa.Column('mood_score', sa.Integer(), nullable=False))
    op.add_column('pbti_result', sa.Column('nature_score', sa.Integer(), nullable=False))
